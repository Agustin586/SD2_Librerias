...
- pin_list:
  - {pin_num: '17', peripheral: SPI0, signal: MISO, pin_signal: LCD_P58/ADC0_DM2/ADC0_SE6a/PTE19/SPI0_MISO/I2C0_SCL/SPI0_MOSI/LCD_P58_Fault}
  - {pin_num: '16', peripheral: SPI0, signal: MOSI, pin_signal: LCD_P57/ADC0_DP2/ADC0_SE2/PTE18/SPI0_MOSI/I2C0_SDA/SPI0_MISO/LCD_P57_Fault}
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_Cs_mcp2515_GPIO, BOARD_Cs_mcp2515_PIN, &Cs_mcp2515_config);

    /* PORTE16 (pin 14) is configured as PTE16 */
    PORT_SetPinMux(BOARD_Cs_mcp2515_PORT, BOARD_Cs_mcp2515_PIN, kPORT_MuxAsGpio);
